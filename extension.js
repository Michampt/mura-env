...
function activate(context) {
	...
	console.log('Congratulations, your extension "mura-env" is now active!');
		...
		provideHover(document, position, token) {
			...
			const map = {
				...
				CONTEXT: {
					type: "String",
					default: "Empty",
					descrtiption: "If Mura is installed under a subdirectory of the webroot, you should enter the path here. Mura will typically populate this field automatically, but you may have to enter the information if you move Mura after being installed."
				},
				COOKIEDOMAIN: {
					type: "String",
					default: "Empty",
				...
				STRICTHTML: {
					type: "Boolean",
					default: "False",
					descriptipn: "If true, Mura will not allow HTML syntax to be used in class extension's extended attributes, unless explicitly excluded via the stricthtmlexclude setting."
				},
				STRICTHTMLEXCLUDE: {
					type: "String",
					default: "Empty",
